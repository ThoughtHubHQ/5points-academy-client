  ...
  return (
    <div className="mt-20 border border-[#1e2939] rounded-[2rem] p-10 md:p-13 flex flex-col lg:flex-row items-center justify-between lg:gap-10">
      <div className="w-full lg:w-1/2 flex flex-col items-start">
        ...
        <p className="text-[#7c8b9d] mt-5 text-base md:text-lg max-w-105 leading-relaxed">
      ...
      <div className="relative w-full lg:w-1/2 flex justify-center items-center min-h-87.5 md:min-h-100">
        <Image
          src="/ctaimg2.jpg"
          alt="CTA Image"
          width={450}
