...
export default function Hero() {
  return (
    <motion.div
      ...
      initial="hidden"
      animate="show"
      className="relative z-0 flex justify-center items-center text-center flex-col px-4 md:px-8 py-5 "
    >
      {/* Background Blur */}
      ...
      <motion.h1
        ...
        className="text-4xl md:text-6xl lg:text-7xl xl:text-8xl text-white font-bold text-center mt-8 md:mt-10 tracking-tight"
      >
      ...
      <motion.p
        variants={itemVariants}
        className="text-base md:text-lg text-muted-foreground max-w-[18rem] sm:max-w-md md:max-w-2xl mx-auto mt-5 md:mt-6 leading-relaxed"
      >
      ...
      <motion.div
        variants={itemVariants}
        className="w-full sm:w-auto flex flex-col sm:flex-row items-center justify-center gap-4 mt-8 md:mt-10"
      >
      ...
      <motion.div
        variants={itemVariants}
        className="grid grid-cols-3 md:grid-cols-3 gap-4 mt-8 md:mt-12 md:border-t border-[#20302e] pt-5 md:pt-12 w-full max-w-5xl mx-auto"
      >
